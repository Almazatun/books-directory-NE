...
exports.AuthorDataAccessLayer = void 0;
var author_model_1 = __importDefault(require("../models/author_model"));
var AuthorDataAccessLayer = /** @class */ (function () {
    function AuthorDataAccessLayer() {
    }
    AuthorDataAccessLayer.prototype.saveNewAuthorDB = function (firstName, lastName) {
    ...
    AuthorDataAccessLayer.prototype.deleteAuthorDB = function (authorId) {
        return __awaiter(this, void 0, void 0, function () {
            var deleteAuthor;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AuthorDataAccessLayer.prototype.getAllAuthors = function () {
        return __awaiter(this, void 0, void 0, function () {
            var authors;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AuthorDataAccessLayer.prototype.searchAuthorsByFistName = function (firstName) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AuthorDataAccessLayer.prototype.findOneAuthorByLastName = function (lastName) {
        return __awaiter(this, void 0, void 0, function () {
            var foundAuthor;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return AuthorDataAccessLayer;
}());
exports.AuthorDataAccessLayer = AuthorDataAccessLayer;
//# sourceMappingURL=author_dal.js.map