...
var authors_bll_1 = __importDefault(require("../services/authors_bll"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, authors_bll_1.default.getAuthors(firstName, res)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
//Crate new author
var createNewAuthor = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstName, lastName;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, firstName = _a.firstName, lastName = _a.lastName;
                return [4 /*yield*/, authors_bll_1.default.createNewAuthor(firstName, lastName, res)];
            case 1:
                _b.sent();
                return [2 /*return*/];
        }
...
var deleteAuthor = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, authors_bll_1.default.deleteAuthor(req.params.id, res)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
