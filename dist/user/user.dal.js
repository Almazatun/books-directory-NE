...
exports.UserDataAccessLayer = void 0;
var user_model_1 = __importDefault(require("../models/user_model"));
var bcrypt_1 = __importDefault(require("bcrypt"));
var UserDataAccessLayer = /** @class */ (function () {
    function UserDataAccessLayer() {
    }
    UserDataAccessLayer.prototype.createNewUser = function (newUserData) {
    ...
    ;
    UserDataAccessLayer.prototype.updateUserData = function (userId, title) {
        return __awaiter(this, void 0, void 0, function () {
            var updatedUserData;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    UserDataAccessLayer.prototype.addBookUserCollection = function (userId, bookId) {
        return __awaiter(this, void 0, void 0, function () {
            var updatedUserData;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    UserDataAccessLayer.prototype.deleteBookUserCollection = function (userId, bookId) {
        return __awaiter(this, void 0, void 0, function () {
            var updatedUserData;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    UserDataAccessLayer.prototype.findOneUserByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var foundUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    UserDataAccessLayer.prototype.findBookUserCollection = function (userId, bookId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    UserDataAccessLayer.prototype.findOneUserById = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var foundUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    UserDataAccessLayer.prototype.getAllUsers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var users;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.UserDataAccessLayer = UserDataAccessLayer;
